...
#define     HFX_RDP_CMD_SET_COMBINE_MODE_TEXEL0             1ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_TEXEL1             2ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_PRIM               3ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_SHADE              4ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_ENV                5ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_CEN                6ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_SCALE              6ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_COMBINED_ALPHA     7ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_TEXEL0_ALPHA       8ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_TEXEL1_ALPHA       9ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_PRIM_ALPHA         10ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_SHADE_ALPHA        11ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_ENV_ALPHA          12ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_LOD_FRACATION      13ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_PRIM_LOD_FRAC      14ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_NOISE              7ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_K4                 7ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_K5                 15ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_1                  6ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_0                  31ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_ALPHA_COMBINED     0ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_ALPHA_TEXEL0       1ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_ALPHA_TEXEL1       2ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_ALPHA_PRIM         3ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_ALPHA_SHADE        4ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_ALPHA_ENV          5ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_ALPHA_LOD_FRAC     0ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_ALPHA_PRIM_LOD_FRAC 6ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_ALPHA_1            6ull
#define     HFX_RDP_CMD_SET_COMBINE_MODE_ALPHA_0            7ull
